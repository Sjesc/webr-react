...
function destroy(shelter, x) {
  ...
  const objs = shelters.get(shelter);
...
var _RObject = class extends RObjectBase {
  ...
  static getStaticPropertyValue(prop) {
    return _RObject[prop];
  }
  ...
  isUnbound() {
    return this.ptr === _RObject.unboundValue.ptr;
  }
  attrs() {
  ...
  setNames(values) {
    ...
    Module._Rf_setAttrib(this.ptr, _RObject.namesSymbol.ptr, namesObj.ptr);
    return this;
  }
  names() {
    const names = RCharacter.wrap(Module._Rf_getAttrib(this.ptr, _RObject.namesSymbol.ptr));
    if (names.isNull()) {
      return null;
    } else {
  ...
  subset(prop) {
    return __privateMethod(this, _slice, slice_fn).call(this, prop, _RObject.bracketSymbol.ptr);
  }
  get(prop) {
    return __privateMethod(this, _slice, slice_fn).call(this, prop, _RObject.bracket2Symbol.ptr);
  }
  getDollar(prop) {
    return __privateMethod(this, _slice, slice_fn).call(this, prop, _RObject.dollarSymbol.ptr);
  }
  pluck(...path) {
    const index = protectWithIndex(_RObject.null);
    try {
  ...
  set(prop, value) {
    ...
    try {
      ...
      protectInc(call, prot);
      return _RObject.wrap(safeEval(call, _RObject.baseEnv));
    } finally {
      unprotect(prot.n);
    }
  }
  ...
  static get globalEnv() {
    return _RObject.wrap(Module.getValue(Module._R_GlobalEnv, "*"));
  }
  static get emptyEnv() {
    return _RObject.wrap(Module.getValue(Module._R_EmptyEnv, "*"));
  }
  static get baseEnv() {
    return _RObject.wrap(Module.getValue(Module._R_BaseEnv, "*"));
  }
  static get null() {
  ...
  static get naString() {
    return _RObject.wrap(Module.getValue(Module._R_NaString, "*"));
  }
  static get true() {
    ...
    case "request": {
      ...
      try {
        switch (reqMsg.type) {
          ...
          case "evalR": {
            const msg2 = reqMsg;
            const result = evalR(msg2.data.code, msg2.data.env);
...
function captureR(code, env, options = {}) {
  var _a;
  const prot = { n: 0 };
  try {
...
function evalR(code, env) {
  var _a, _b;
  const capture = captureR(code, env, void 0);
